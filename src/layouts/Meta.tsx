  ...
  return (
    <>
      <Head>
        ...
        <meta name='keyword' property='og:keyword' itemProp='keyword' content={meta.keyword} />
        <meta name='website' property='og:website' itemProp='website' content={meta.website} />
        ...
        <link rel='icon' href={`${basePath}/android-chrome-192x192.png`} key='favicon' />
        <link rel='icon' href={`${basePath}/android-chrome-512x512.png`} key='favicon' />
